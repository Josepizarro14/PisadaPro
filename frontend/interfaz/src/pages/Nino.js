...
const Niño = () => {
    ...
    // Obtener productos de la categoría "Niño" al cargar el componente
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const data = await getProductsByCategory('Niño');
                setProducts(data);
            } catch (error) {
    ...
    return (
        <div className="container mt-4">
            <h2 className="text-center mb-4">Zapatillas para Niño</h2>
            <div className="row">
